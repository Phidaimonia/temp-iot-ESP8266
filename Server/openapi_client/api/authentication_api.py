...
class AuthenticationApi(object):
    ...
    def login(
        ...
        **kwargs
        ...
        Login by username and password in the post body. The teamUUID will be returned in the response, use it in the header parameter of the subsequent API calls.  # noqa: E501
        ...
        Args:
            login (Login): Authenticate by username and password
