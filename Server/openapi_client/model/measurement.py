...
class Measurement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_on, sensor_uuid, temperature, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_on, sensor_uuid, temperature, status, *args, **kwargs):  # noqa: E501
        """Measurement - a model defined in OpenAPI
